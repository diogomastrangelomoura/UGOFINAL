...
!function ($) {
    ...
    var Dashboard = function () {
        ...
        Dashboard.prototype.init = function () {
            ...
            this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b'], ['Series A', 'Series B'], ['#6f2f9f', '#000']);

            //creating donut chart
            var $donutData = [
                {label: "Realizados", value: 42},
                {label: "Restantes", value: 12}
            ];
            this.createDonutChart('morris-donut-example', $donutData, ['#6f2f9f', '#000']);
